...
install -p -m644 %{SOURCE3} %{buildroot}%{_datadir}/icons/hicolor/16x16/apps/gvim.png
install -p -m644 %{SOURCE4} %{buildroot}%{_datadir}/icons/hicolor/32x32/apps/gvim.png
install -p -m644 %{SOURCE5} %{buildroot}%{_datadir}/icons/hicolor/48x48/apps/gvim.png
install -p -m644 %{SOURCE6} %{buildroot}%{_datadir}/icons/hicolor/64x64/apps/gvim.png
...
#%transfiletriggerpostun common -- %{_datadir}/%{name}/vimfiles/doc > %{_datadir}/%{name}/vimfiles/doc/tags
#%{_bindir}/vim -c ":helptags %{_datadir}/%{name}/vimfiles/doc" -c :q &> /dev/null
